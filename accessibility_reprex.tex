...
\begin{document}
  ...
  %%%%%% Cover image
  \includegraphics[alt=An illustration of petrale sole]{partials/Petrale\_sole.png}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'A good alternative text for our example image'}]{figures/example-external-img.png}}
